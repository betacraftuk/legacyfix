...
Prism Launcher and MultiMC use inferior Mojang asset indexes for versions before 1.7.3-pre.<br>
...
<br>
\* The moment you first ran LegacyFix with your Prism/MultiMC instance, it replaced the inaccurate asset index used by the launcher for that instance to the accurate one (one that also doesn't tell the launcher to copy assets into `resources`).
