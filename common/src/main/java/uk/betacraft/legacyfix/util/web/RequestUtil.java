...
public class RequestUtil {
    public static String webDataToString(WebData data) {
        if (data.getData() != null) {
            try {
                ...
                Logger.error("webDataToString", t);
            }
        }
        return null;
    }
    ...
    public static WebData performRawPOSTRequest(Request req) {
        try {
            ...
            Logger.error("performRawPOSTRequest", e);
            return new WebData(null, -2);
        } catch (Throwable t) {
            Logger.error("performRawPOSTRequest", t);
    ...
    public static WebData performRawGETRequest(Request req) {
        try {
            ...
            Logger.error("performRawGETRequest", e);
            return new WebData(null, -2);
        } catch (Throwable t) {
            Logger.error("performRawGETRequest", t);
            return new WebData(null, -1);
        }
    }
    ...
    public static String getIPFromAmazon() {
        try {
            ...
            Logger.error("Failed to get IP from checkip.amazonaws.com, user is probably offline");
            Logger.error("getIPFromAmazon", t);
        }
        return null;
    }
