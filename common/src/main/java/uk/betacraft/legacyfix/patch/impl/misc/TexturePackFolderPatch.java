...
public class TexturePackFolderPatch extends Patch {
    ...
    public void apply(PatchPool patchPool) throws Exception {
        CtClass sysClass = patchPool.getClass("org.lwjgl.Sys");

        CtMethod openURLMethod = sysClass.getDeclaredMethod("openURL", new CtClass[]{Patch.CT_STRING});
